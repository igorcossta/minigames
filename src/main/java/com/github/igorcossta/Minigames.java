...
public class Minigames extends JavaPlugin {
    ...
    private GameCountdownScheduler gameCountdownScheduler;
    ...
    public void onEnable() {
        ...
        this.getServer().getPluginManager().registerEvents(new MinigameStartListener(this.gameCountdownScheduler), this.instance);
    }
    ...
    private void loadConfigurations() {
        ...
        this.gameCountdownScheduler = new GameCountdownScheduler();
